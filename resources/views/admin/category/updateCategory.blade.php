        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('admin#updateCategory',$data->id)}}" method="POST">
                    ...
                    <div class="button-group d-flex flex-col justify-content-between">
                        <a href="{{route('admin#category')}}" class="btn btn-dark"><i class="fa-solid fa-angle-left me-1"></i>Back</a>
